...
```
==================================================================
  259 checks passed, 0 failed, 259 total
==================================================================
...
| (c) Mawangdui family swapped | `3.1`, Mawangdui inversions vs binary | the run completes and reports `241 checks passed, 18 failed, 259 total` |
