...
```
==================================================================
  261 checks passed, 0 failed, 261 total
==================================================================
...
| (c) Mawangdui family swapped | `3.1`, Mawangdui inversions vs binary | the run completes and reports `241 checks passed, 20 failed, 261 total` |
