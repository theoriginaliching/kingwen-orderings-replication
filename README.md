...
```
==================================================================
  264 checks passed, 0 failed, 264 total
==================================================================
...
| (c) Mawangdui family swapped | `3.1`, Mawangdui inversions vs binary | the run completes and reports `246 checks passed, 18 failed, 264 total` |
